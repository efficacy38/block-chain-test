    ...
    <div class="row justify-content-between align-items-start text-center pt-5">
        ...
        <div class="card shadow">
          <div class="card-body">
            ...
            <div class="input-group my-3">
              <input type="number" class="form-control" v-model="swapAmount">
            ...
            <button class="btn btn-outline-secondary w-100" type="button">Swap</button>
          </div>
        </div>
      </div>
        ...
        <div class="card shadow">
          <div class="card-body">
            ...
            <div class="text-start">
              <h6>Current Amounts of JHT: {{ JHTAmount }} JHT</h6>
              <h6>Current Amounts of ETH: {{ ETHAmount }} ETH</h6>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12 my-3">
        <div class="card shadow">
          ...
          consectetur vel architecto nam eum doloribus exercitationem possimus ratione ut similique facere alias, commodi
          pariatur.
        </div>
      </div>
    </div>
