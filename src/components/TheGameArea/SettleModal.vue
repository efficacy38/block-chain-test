<template>
  <div
    :class="['modal', isModalOpen ? 'open show d-block' : 'fade']"
    tabindex="-1"
  >
        ...
        <div class="modal-content" v-else>
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">
              <span
                v-if="
                  roundStatus === GAME_STATUS.WIN ||
                  roundStatus === GAME_STATUS.LOSE
                "
                >You {{ roundStatus }}.
              </span>
              Make a New Game?
          ...
          <div class="modal-body">
            <div
              v-if="startStatus.type"
              :class="['alert', `alert-${startStatus.type}`]"
            >
