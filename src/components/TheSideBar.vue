<template>
  <aside class="sidebar" :class="{ 'open': showDrawer }">
    ...
    <p class="tagline">
      Built with
      <a href="https://vuejs.org/" title="vuejs.org" target="_blank">
        Vue.js
      </a>
    </p>
    ...
    <div class="footer">
      <p>
        ...
        <a href="https://twitter.com/kevinleedrum" title="twitter" target="_blank">
          Kevin Lee Drum
        </a>
      </p>
      <p>
        <a href="https://github.com/kevinleedrum/vlackjack/" title="GitHub project page" target="_blank">
          GitHub project page
        </a>
      </p>
    </div>
